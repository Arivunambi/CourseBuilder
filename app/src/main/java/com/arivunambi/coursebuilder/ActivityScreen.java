...
public class ActivityScreen extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i = new Intent(ActivityScreen.this, LoginScreen.class);
            startActivity(i);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(ActivityScreen.this, HomeScreen.class);
            startActivity(i);
        } else if (id == R.id.nav_quiz) {
            Intent i = new Intent(ActivityScreen.this, QuizScreen.class);
            startActivity(i);
